---
title: PWA with `injectManifest`
description: Create a simple PWA and provide your own service worker to gain more control over the behavior.
categories: [Setup, Caching]
---
